...
$(document).on("click", "#_vvod", function() {
	...
	var arr =
		[
			document.getElementById("_p1").value,
			document.getElementById("_p2").value,
			document.getElementById("_p3").value,
			document.getElementById("_p4").value,
			document.getElementById("_p5").value,
			document.getElementById("_p6").value
		];
